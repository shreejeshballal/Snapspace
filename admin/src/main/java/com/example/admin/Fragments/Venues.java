...
import com.example.admin.adapters.VenueAdaptor;
...
public class Venues extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        venueAdpaters = new VenueAdaptor(getActivity(),venueModelList,venueRecycler);
        venueRecycler.setAdapter(venueAdpaters);
        venueAdpaters.setOnclickListener(new VenueAdaptor.OnItemclickListen() {
            @Override
